...
public enum Exceptions {
  ...
  ELASTIC_ALBUM_IS_NOT_FOUND("Album with this id isn't present!"),
  ELASTIC_ARTIST_IS_NOT_FOUND("Artist with this id isn't present!"),
  ELASTIC_LABEL_IS_NOT_FOUND("Label with this id isn't present!"),
  ELASTIC_SONG_IS_NOT_FOUND("Song with this id isn't present!"),
